# career-review (Codex stub)

Execute the workflow `career-review` exactly as specified in
`.claude/commands/career-review.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/career-review.md` — the workflow itself
