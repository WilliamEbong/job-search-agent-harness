# companies (Codex stub)

Execute the workflow `companies` exactly as specified in
`.claude/commands/companies.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/companies.md` — the workflow itself
