...
Execute the workflow `reset` exactly as specified in
`.claude/commands/reset.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/reset.md` — the workflow itself
