# setup-harness (Codex stub)

Execute the workflow `setup-harness` exactly as specified in
`.claude/commands/setup-harness.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/setup-harness.md` — the workflow itself
