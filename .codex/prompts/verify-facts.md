# verify-facts (Codex stub)

Execute the workflow `verify-facts` exactly as specified in
`.claude/commands/verify-facts.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/verify-facts.md` — the workflow itself
