# notion-sync (Codex stub)

Execute the workflow `notion-sync` exactly as specified in
`.claude/commands/notion-sync.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/notion-sync.md` — the workflow itself
