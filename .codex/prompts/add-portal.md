# add-portal (Codex stub)

Execute the workflow `add-portal` exactly as specified in
`.claude/commands/add-portal.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/add-portal.md` — the workflow itself
3. `RUNTIME-MAP.md` — §3 (tool-name mapping), §4 (portal CLIs are runtime-neutral), §5 (never print a usage percentage on Codex)
