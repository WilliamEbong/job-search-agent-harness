...
Execute the workflow `outcome` exactly as specified in
`.claude/commands/outcome.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/outcome.md` — the workflow itself
