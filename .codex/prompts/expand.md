...
Execute the workflow `expand` exactly as specified in
`.claude/commands/expand.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/expand.md` — the workflow itself
3. `RUNTIME-MAP.md` — §2 (no Agent tool), §3 (tool-name mapping), §5 (never print a usage percentage on Codex)
