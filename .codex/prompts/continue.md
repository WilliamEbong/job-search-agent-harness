...
Execute the workflow `continue` exactly as specified in
`.claude/commands/continue.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/continue.md` — the workflow itself
