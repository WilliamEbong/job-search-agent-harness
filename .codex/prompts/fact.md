...
Execute the workflow `fact` exactly as specified in
`.claude/commands/fact.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/fact.md` — the workflow itself
