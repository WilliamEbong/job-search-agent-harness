# html-report (Codex stub)

Execute the workflow `html-report` exactly as specified in
`.claude/commands/html-report.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/html-report.md` — the workflow itself
