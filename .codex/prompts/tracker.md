...
Execute the workflow `tracker` exactly as specified in
`.claude/commands/tracker.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/tracker.md` — the workflow itself
