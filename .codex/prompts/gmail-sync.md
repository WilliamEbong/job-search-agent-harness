# gmail-sync (Codex stub)

Execute the workflow `gmail-sync` exactly as specified in
`.claude/commands/gmail-sync.md`, applying `RUNTIME-MAP.md` wherever that file
...
2. `.claude/commands/gmail-sync.md` — the workflow itself
